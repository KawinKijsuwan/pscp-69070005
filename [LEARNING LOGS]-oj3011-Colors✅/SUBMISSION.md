...
```text
โจทย์ให้อ่านชื่อสีสองสี แล้วผสมกันแล้วจะได้สีอะไรตามเเม่สี
Input:
รับข้อความสองบรรทัด เป็นชื่อสี first_color และ second_color
Output:
โปรแกรมควรพิมพ์ชื่อสีที่ได้
Red + Yellow  พิมพ์ "Orange"
Red + Blue พิมพ์ "Violet"
Yellow + Blue พิมพ์ "Green"
ถ้าทั้งสองสีเหมือนกันและเป็นเเม่สีพิมพ์สีที่พิมพ์ไป
ถ้าไม่ตรงพิมพ์ "Error"
Constraints:
input เป็น string ชื่อสีตัวพิมพ์ใหญ่ตัวแรกไม่อยู่ในสามสีนี้ หรือค่าว่างก็ได้ ต้องรองรับกรณีเหล่านี้ด้วยการพิมพ์ "Error"
```
...
```text
Step 1: อ่านสีที่ 1 และสีที่ 2
Step 2: Red + Yellow พิม Orange
Step 3: Red + Blue พิม Violet
Step 4: Yellow + Blue พิม Green
Step5: สีเดีนวกันเเล้วอยู่ในเเม่สี พิมสีที่รับinput
Step6: อยู่นอกเงื่อนไขมั้งหมด พิม Error
```
...
```text
สุดท้ายมีการเพิ่ม or ในส่วนผสมเเม่สี เช่น Red + Yellow or Yellow + Red
```
