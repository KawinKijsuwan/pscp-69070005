...
```text
โจทย์ให้อ่านข้อความ แล้วแปลงเป็นตัวพิมพ์เล็กทั้งหมด เเล้วก็พิมพ์ข้อความนั้นแบบกลับด้าน
Input:
รับข้อความ
Output:
โปรเเกรมควรพิมพ์ข้อความจากหลังไปหน้า เช่น input:"hello" output:"olleh" เเละควรเป็นตัวเล็กหมด
Constraints:
inputมีทั้งตัวพิมพ์เล็กและตัวพิมพ์ใหญ่ปนกัน
```
...
```text
Step 1: อ่านข้อความ
Step 2: เเปลงเป็นตัวเล็กให้หมด text.lower()
Step 3: กลับด้านข้อความ[::-1]
Step 4: ผลลัพ
```
